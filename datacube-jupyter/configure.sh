...
aws s3 cp s3://dea-public-data/LS8_OLI_PQ/ls8_pq_albers.json /opt/data/LS8_OLI_NBART/
aws s3 cp s3://dea-public-data//LS8_OLI_NBART/10_-44/LS8_OLI_NBART_3577_10_-44_20170816001616000000_v1508468655.nc /opt/data/LS8_OLI_NBART/10_-44/

datacube system init

datacube product add /opt/data/ls8_nbart_albers.json
datacube product add /opt/data/ls8_pq_albers.json

datacube dataset add /opt/data/LS8_OLI_NBART/10_-44/*
