            ...
            },
            {
                ...
                "styles": [
                    ...
                    # Examples of non-linear heat-mapped styles.
                    {
                        ...
                        "abstract": "Normalised Difference Vegetation Index - a derived index that correlates well with the existence of vegetation",
                        "heat_mapped": True,
                        "index_function": lambda data: (data["nbar_nir_1"] - data["nbar_red"]) / (
                                    data["nbar_nir_1"] + data["nbar_red"]),
                        "needed_bands": ["nbar_red", "nbar_nir_1"],
                        # Areas where the index_function returns outside the range are masked.
                        "range": [0.0, 1.0],
                    },
                    {
                        ...
                        "abstract": "Normalised Difference Water Index - a derived index that correlates well with the existence of water",
                        "heat_mapped": True,
                        "index_function": lambda data: (data["nbar_green"] - data["nbar_nir_1"]) / (
                                    data["nbar_nir_1"] + data["nbar_green"]),
                        "needed_bands": ["nbar_green", "nbar_nir_1"],
                        "range": [0.0, 1.0],
                    },
                    {
                        ...
                        "abstract": "Normalised Difference Buildup Index - a derived index that correlates with the existence of urbanisation",
                        "heat_mapped": True,
                        "index_function": lambda data: (data["nbar_swir_3"] - data["nbar_nir_1"]) / (
                                    data["nbar_swir_3"] + data["nbar_nir_1"]),
                        "needed_bands": ["nbar_swir_3", "nbar_nir_1"],
                        "range": [0.0, 1.0],
                    },
                    # Mask layers - examples of how to display raw pixel quality data.
        ...
        "products": [
            {
                ...
                "styles": [
                    ...
                    # Examples of non-linear heat-mapped styles.
                    {
                        ...
                        "abstract": "Normalised Difference Vegetation Index - a derived index that correlates well with the existence of vegetation",
                        "heat_mapped": True,
                        "index_function": lambda data: (data["nbar_nir"] - data["nbar_red"]) / (
                                    data["nbar_nir"] + data["nbar_red"]),
                    ...
                    },
                    {
                        ...
                        "abstract": "Normalised Difference Water Index - a derived index that correlates well with the existence of water",
                        "heat_mapped": True,
                        "index_function": lambda data: (data["nbar_green"] - data["nbar_nir"]) / (
                                    data["nbar_nir"] + data["nbar_green"]),
                    ...
                    },
                    {
                        ...
                        "abstract": "Normalised Difference Buildup Index - a derived index that correlates with the existence of urbanisation",
                        "heat_mapped": True,
                        "index_function": lambda data: (data["nbar_swir_2"] - data["nbar_nir"]) / (
                                    data["nbar_swir_2"] + data["nbar_nir"]),
